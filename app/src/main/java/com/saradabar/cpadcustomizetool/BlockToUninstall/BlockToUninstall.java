package com.saradabar.cpadcustomizetool.BlockToUninstall;
...
public class BlockToUninstall extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dpm = (DevicePolicyManager)this.getSystemService("device_policy");
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            dpm.setUninstallBlocked(administratorComponent, selectPackage.replace("package:", ""), bl);
        ...
        unDisableButton.setOnClickListener(v -> {
            for (AppData appData : dataList) {
                dpm.setUninstallBlocked(administratorComponent, appData.packName, false);
            }
            ((Switch) AppListAdapter.view.findViewById(R.id.un_switch)).setChecked(false);
            listView.invalidateViews();
            appListAdapter.loadList();
        });

        //有効
        unEnableButton.setOnClickListener(v -> {
            for (AppData appData : dataList) {
                dpm.setUninstallBlocked(administratorComponent, appData.packName, true);
            }
